...
import com.belial.maker.generator.file.FileGenerator;
...
public class GenerateCommand implements Runnable{
    ...
    public void run() {
        ...
        DataModel config = BeanUtil.copyProperties(this, DataModel.class);
        try {
            FileGenerator.doGenerator(inputPath, outputPath, config);
